...
export function CapitalWaterLevelCard({ totalNetWorth, settings, loading }: CapitalWaterLevelCardProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm h-full flex flex-col justify-between group hover:shadow-md dark:hover:bg-gray-800/50 transition-all relative overflow-hidden">
            <div className="space-y-2 relative z-10">
                <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">{t('dashboard.capital_water_level')}</p>
