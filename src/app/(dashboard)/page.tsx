...
// Widgets
import { TotalBalanceCard } from '@/app/(dashboard)/_components/TotalBalanceCard';
import { MonthlyFlowCard } from '@/app/(dashboard)/_components/MonthlyFlowCard';
import { CapitalWaterLevelCard } from '@/app/(dashboard)/_components/CapitalWaterLevelCard';
import { RecentTransactionsWidget } from '@/app/(dashboard)/_components/RecentTransactionsWidget';
import { QuickActionsWidget } from '@/app/(dashboard)/_components/QuickActionsWidget';
import { ExpenseCompositionChart } from '@/app/(dashboard)/_components/ExpenseCompositionChart';
